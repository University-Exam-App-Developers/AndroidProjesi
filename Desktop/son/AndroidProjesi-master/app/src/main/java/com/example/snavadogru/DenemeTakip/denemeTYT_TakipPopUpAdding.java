...
public class denemeTYT_TakipPopUpAdding extends AppCompatDialogFragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            ...
            throw new ClassCastException(getContext().toString() + " must implement dialog");
        }
    }

    public void setNameIncrement(int number) {
        increment = number;
    }
