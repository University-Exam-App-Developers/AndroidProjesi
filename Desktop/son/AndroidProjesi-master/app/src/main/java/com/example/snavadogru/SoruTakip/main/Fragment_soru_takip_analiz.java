...
public class Fragment_soru_takip_analiz extends Fragment{
    ...
    //    Log.d("fill", "Calendar.MONTH+2: "+(Calendar.getInstance().get(Calendar.MONTH)+1)+" - "+(monthSize+11));
                monthOfYear=calendar.get((Calendar.getInstance().get(Calendar.MONTH)+1-monthSize+12)%12);
