...
public class denemeSAY_TakipPopUpadding extends AppCompatDialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            edits.get(0).setTextColor(Color.WHITE);
            edits.get(1).setTextColor(Color.WHITE);
            edits.get(0).setHintTextColor(Color.LTGRAY);
            edits.get(1).setHintTextColor(Color.LTGRAY);
            ...
            for (int i = 0; i <edits.size() ; i++){
                edits.get(i).setTextColor(Color.WHITE);
                edits.get(i).setHintTextColor(Color.LTGRAY);}
