package ykskoc.example.snavadogru.Kendin.zamanTakipSqlite;
...
public class zamanTakipMyDataBaseHelper_Month extends SQLiteOpenHelper {
    private Context context;
    private static final String DataBase_Name="zamanTakipMonth_Table.db";
    ...
    public zamanTakipMyDataBaseHelper_Month(@Nullable Context context) {
    ...
    public Cursor queryLastItem(int monthNumb){
    ...
    public void removeSingleData(int monthName){
        ...
        if (result==-1){
      //      Log.d("removeSingleData","Month_Name ÇIKMADIIIIIIIIIIIIIIIIII");
            Toast.makeText(context,"Hata Oluştu",Toast.LENGTH_SHORT).show();
        }
    //    else
