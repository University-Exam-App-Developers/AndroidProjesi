package ykskoc.example.snavadogru.Kendin.SqLite;
...
public class MyDataBaseHelper extends SQLiteOpenHelper {
    ...
    public void removeDate(int gorevWeek,int dayNumb){
        SQLiteDatabase db = this.getWritableDatabase();
        long result= db.delete(Table_Name,Column_Week+" = ?"+" AND "+Column_Day+" = ?",new String[]{gorevWeek+"",dayNumb+""});
